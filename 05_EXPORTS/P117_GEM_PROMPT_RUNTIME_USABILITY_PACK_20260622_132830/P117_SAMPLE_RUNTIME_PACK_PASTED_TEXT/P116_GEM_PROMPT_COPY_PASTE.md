...
```text
BTC 0.10 value EUR 6500; ETH 1.20 value EUR 4200; USDC 1000 value EUR 920; source=manual sample; prices not verified.
```

### Notes
P117 sample runtime pack. Human review only.
