...
Write-Host "============================================================"
Write-Host "P_REFLEX_09 LOCAL PRIVATE PREVIEW"
Write-Host "URL=http://localhost:3000/"
Write-Host "ADMIN_THEME=http://localhost:3000/admin/theme"
Write-Host "ADMIN_DATA=http://localhost:3000/admin/data-binding"
