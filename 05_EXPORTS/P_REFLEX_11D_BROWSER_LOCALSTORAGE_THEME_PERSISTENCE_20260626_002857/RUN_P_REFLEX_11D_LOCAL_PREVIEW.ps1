& {
  try {
    ...
    Write-Host "============================================================"
    Write-Host "P_REFLEX_11D LOCAL PRIVATE PREVIEW"
    Write-Host "HOME=http://localhost:3000/"
    Write-Host "THEME=http://localhost:3000/admin/theme"
    Write-Host "CHECK=Persist Light / Persist Dark / Persist System"
    Write-Host "LOCALSTORAGE_KEY=mvp_qaic_ui_theme_preference_v1"
    ...
    Write-Host "STATUS=FAILED_P_REFLEX_11D_LOCAL_PREVIEW"
